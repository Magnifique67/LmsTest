...
public class TransactionServiceIntegrationTest {
    ...
    void setUp() {
        ...
        book.setAvailability(true); // Set book as available
    ...
    void testBorrowBook() {
        ...
        assertThat(borrowedTransaction.getIssueDate()).isEqualTo(LocalDate.now());
        assertThat(borrowedTransaction.getDueDate()).isEqualTo(LocalDate.now().plusDays(14));
